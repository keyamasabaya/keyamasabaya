// Theme-agnostic SVG asset generator for the keyamasabaya GitHub profile.
...
<text x="112" y="${H / 2}" font-family="${FONT}" font-size="14.5" dominant-baseline="central" xml:space="preserve"><tspan fill="${MUTED}" font-weight="600">keyamasabaya@wespify</tspan><tspan fill="${CYAN}" font-weight="700"> :~$ </tspan><tspan fill="${TEXT}" font-weight="600">${esc(command)}</tspan><tspan fill="${CYAN}" font-weight="700"> ▍</tspan></text>
</svg>`;
